...
// {notes.map(note => {
//   return(<div key={note._id} className="w-full h-[60px] bg-slate-100 rounded-xl flex flex-col px-3 py-2">
//     <div className="w-full text-md font-semibold">{note.title}</div>
//     <div className="flex item-center">
//       <small className="text-sm">{formatTimeSince(note._creationTime)}</small>
//     </div>
//   </div>)
// })}

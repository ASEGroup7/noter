...
export default function Page({ params } : { params : { id: string } }) {
  ...
  return (
    <div className="min-h-[calc(100vh-70px)] px-[5%] grid grid-cols-12 gap-8">
      {/* <DetailsForm form={form} onSubmit={onSubmit} className="col-span-12 lg:col-span-7" id={params.id}/> */}
      
      <iframe 
        src={`https://docs.google.com/gview?url=https://utfs.io/f/${params.id}&embedded=true`} 
        className="w-0 h-0 lg:w-full lg:h-[calc(100vh-130px)]"
      />
    </div>
  )
}

// function DetailsForm({ id, form, onSubmit, className } : { 
//   id: string,
//   form: UseFormReturn<{
//     title: string;
//     description: string;
